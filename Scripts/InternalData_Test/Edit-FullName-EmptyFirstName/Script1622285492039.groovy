...
WebUI.setText(findTestObject('Page_Town Square/Edit/input_First Name_firstName'), findTestData('InternalData/EditAccount').getValue(1, 7))
WebUI.setText(findTestObject('Page_Town Square/Edit/input_Last Name_lastName'), findTestData('InternalData/EditAccount').getValue(6, 7))
...
WebUI.verifyMatch(fullName, findTestData('InternalData/EditAccount').getValue(7, 7), false)
WebUI.closeBrowser()
