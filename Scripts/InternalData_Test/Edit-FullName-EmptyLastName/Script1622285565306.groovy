...
WebUI.setText(findTestObject('Page_Town Square/Edit/input_First Name_firstName'), findTestData('InternalData/EditAccount').getValue(1, 6))
WebUI.setText(findTestObject('Page_Town Square/Edit/input_Last Name_lastName'), findTestData('InternalData/EditAccount').getValue(6, 6))
...
WebUI.verifyMatch(fullName, findTestData('InternalData/EditAccount').getValue(7, 6), false)
WebUI.closeBrowser()
