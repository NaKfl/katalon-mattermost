...
for (def rowNum = 1; rowNum <= findTestData('Data Files/CSV/username').getRowNumbers(); rowNum++) {
	String username = findTestData('Data Files/CSV/username').getValue(1, rowNum)
