...
String positioin=findTestData('InternalData/EditAccount').getValue(4, 1)

WebUI.callTestCase(findTestCase('Test Cases/CommonTestCase/TC-Common-EditPosition'), [('position') : positioin], FailureHandling.STOP_ON_FAILURE)
